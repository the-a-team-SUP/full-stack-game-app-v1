    ...
    return (
      <div className="wrapper">
        <div>
          <h4>Online Users</h4>
          <div className="users">
            <image src="https://media.istockphoto.com/photos/businessman-silhouette-as-avatar-or-default-profile-picture-picture-id476085198?k=6&m=476085198&s=612x612&w=0&h=5cDQxXHFzgyz8qYeBQu2gCZq1_TN0z40e_8ayzne0X0="></image>{" "}
            <b>
              <p>Doddy</p>
            </b>
          ...
          <br></br>
          <div class="users">
            <img src="https://st4.depositphotos.com/9637256/22048/i/1600/depositphotos_220489228-stock-photo-delicious-homemade-whole-cake-mascarpone.jpg"></img>{" "}
            <b>
              <p>Karen</p>
            </b>
